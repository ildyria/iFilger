...
p. I'm currently updating the main core of Tukui_iFilger (thx SinaC, memory used divided by about 2). I have to do the same for iFilger.
I may try to make an ingame config ui, but I don't realy know how, so don't expect that mutch.
