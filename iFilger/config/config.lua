...
C["general"] = {
	...
	["bordercolor"] = { .6,.6,.6 },                     -- default border color of panels								-- enter in iFilger config mode : display buffs
}
...
C["Filger_Spells"] = {
	["DEATHKNIGHT"] = {
		...
		},
		{
			...
			--Sudden Doom
			{ spellID = 49530, size = 48, unitId = "player", caster = "all", filter = "BUFF" },
			--Crimson Scourge
			{ spellID = 81135, size = 48, unitId = "player", caster = "all", filter = "BUFF" },
			--Killing Machine
			{ spellID = 51128, size = 48, unitId = "player", caster = "all", filter = "BUFF" }, 
...
--			{ spellID = 44614, size = 30, unitId = "target", caster = "all", filter = "DEBUFF" },
			--Slow
			{ spellID = 31589, size = 30, unitId = "target", caster = "player", filter = "DEBUFF" },
			--Icy Veins
			{ spellID = 12472, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			--Arcane Power
			{ spellID = 12042, size = 30, unitId = "player", caster = "all", filter = "BUFF" },
			--Ice Block
			{ spellID = 45438, size = 30, unitId = "player", caster = "player", filter = "BUFF" }, 
			--Invisibility
			{ spellID = 66, size = 30, unitId = "player", caster = "all", filter = "BUFF" }, 
			--Pyromaniac
			{ spellID = 34295, size = 30, unitId = "player", caster = "all", filter = "BUFF" }, 
			--Pyroblast
			{ spellID = 11366, size = 30, unitId = "target", caster = "player", filter = "DEBUFF" }, 
			--Pyroblast!
			{ spellID = 92315, size = 30, unitId = "target", caster = "player", filter = "DEBUFF" }, 
			--Living Bomb
			{ spellID = 44457, size = 30, unitId = "target", caster = "player", filter = "DEBUFF" }, 
			--Ignite
			{ spellID = 12846, size = 30, unitId = "target", caster = "player", filter = "DEBUFF" }, 
			--Impact
			{ spellID = 12357, size = 30, unitId = "target", caster = "all", filter = "DEBUFF" }, 
			--Combustion
			{ spellID = 11129, size = 30, unitId = "target", caster = "player", filter = "DEBUFF" }, 
			--Scorch aka Critical Mass
			{ spellID = 12873, size = 30, unitId = "target", caster = "all", filter = "DEBUFF" },
			--Freeze
			{ spellID = 33395, size = 30, unitId = "target", caster = "all", filter = "DEBUFF" }, 
		},
		{
			Name = "Mage Procs",
			Direction = "RIGHT",
			...
			--Clearcasting
			{ spellID = 12536, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			--Missiles
			{ spellID = 79683, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			--Brain Freeze
			{ spellID = 57761, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			-- Impact
			{ spellID = 64343, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			--Hot Streak(improved)
			{ spellID = 44448, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			--Hot Streak
			{ spellID = 44445, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			--Arcane Blast
			{ spellID = 30451, size = 48, unitId = "player", caster = "player", filter = "DEBUFF" },
			--Fingers Of Frost
            { spellID = 83074, size = 48, unitId = "player", caster = "player", filter = "BUFF"},
			--Blazing Speed
			{ spellID = 31642, size = 48, unitId = "player", caster = "all", filter = "BUFF" },
		},
		{
			Name = "Focus",  
			Direction = "LEFT",
	...
	["PRIEST"] = { -------------------------------------------------------------------------------------------------------- Priest
		...
		},
		{
			...
			--Holy Word: Sanctuary
			{ spellID = 88686, size = 30, filter = "CD" }, 
			--Inner Focus
		...
		},	
		{
			...
			-- Guardian Spirit
			{ spellID = 47788, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Pain Suppression
			{ spellID = 33206, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Renew
			{ spellID = 139, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Power Word: Shield
			{ spellID = 17, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Inner Focus
			{ spellID = 89485, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Strength of Soul
			{ spellID = 96267, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Empowered Shadow / Machterfüllte Schatten
			{ spellID = 95799, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Fade / Verblassen
			{ spellID = 586, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			
			-- Chakra: Serenity
			{ spellID = 81208, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Chakra: Sanctuary
			{ spellID = 81206, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Chakra: Chastise
			{ spellID = 81209, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
		},
	    {
			Name = "Priest Procs",
			Direction = "RIGHT",
			...
			-- Surge of Light
			{ spellID = 88688, size = 48, unitId = "player", caster = "all", filter = "BUFF" },
			-- Serendipity
			{ spellID = 63735, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			-- Shadow Orb
			{ spellID = 77487, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			-- Archangel
			{ spellID = 81700, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			-- Evangelism
			{ spellID = 81662, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			-- Dark Archangel
			{ spellID = 87153, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			-- Dark Evangelism
			{ spellID = 87118, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			-- Dispersion
			{ spellID = 47585, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
		},	
		{
			...
			{ spellID = 41635, size = 30, unitId = "target", caster = "player", filter = "BUFF" },
			-- Guardian Spirit / Schutzgeist
			{ spellID = 47788, size = 30, unitId = "target", caster = "player", filter = "BUFF" },
			-- Pain Suppression / Schmerzunterdrückung
			{ spellID = 33206, size = 30, unitId = "target", caster = "player", filter = "BUFF" },
			-- Power Word: Shield / Machtwort: Schild
			{ spellID = 17, size = 30, unitId = "target", caster = "player", filter = "BUFF" },
			-- Renew / Erneuerung
			{ spellID = 139, size = 30, unitId = "target", caster = "player", filter = "BUFF" },
			-- Fear Ward / Furchtzauberschutz
			{ spellID = 6346, size = 30, unitId = "target", caster = "player", filter = "BUFF" },
			-- Echo of Light / Echo des Lichts
			{ spellID = 77489, size = 30, unitId = "target", caster = "player", filter = "BUFF" },
			-- Inspiration / Inspiration
			{ spellID = 15357, size = 30, unitId = "target", caster = "player", filter = "BUFF" },
			-- Grace / Barmherzigkeit
			{ spellID = 77613, size = 30, unitId = "target", caster = "player", filter = "BUFF" },
		},
		{
	...
	["WARLOCK"] = { -------------------------------------------------------------------------------------------------------- Warlock
		{
			...
			-- Demon Soul: Imp
			{ spellID = 79459, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Demon Soul: Felguard
			{ spellID = 79462, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Demon Soul: Felhunter
			{ spellID = 79460, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Eradication
			{ spellID = 64371, size = 30, unitId = "player", caster = "player", filter = "BUFF" },	
			--Devious Minds
			{ spellID = 70840, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Improved Soul Fire
			{ spellID = 85383, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Molten Core
			{ spellID = 47247, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Decimation
			{ spellID = 63158, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Backdraft
			{ spellID = 47258, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Backlash
			{ spellID = 34936, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			-- Nether Protection
			...
			-- Burning Soul
			{ spellID = 84254, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			--Empowered Imp
			{ spellID = 47283, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
			--Shadow Trance
			{ spellID = 17941, size = 30, unitId = "player", caster = "player", filter = "BUFF" },			
		...
		},
		{
			...
			-- Shadow Embrace
			{ spellID = 32395, size = 30, unitId = "target", caster = "player", filter = "BUFF" },
			-- Corruption
		...
		},
		{
			...
			-- Soul Swap
			{ spellID = 86121, size = 30, unitId = "player", caster = "player", filter = "BUFF" },
		},
        {
			Name = "Cooldown",
			Direction = "LEFT",
...
--			IconSide = "RIGHT",
	...
	["DRUID"] = { -------------------------------------------------------------------------------------------------------- Druid
		...
		},
		{
			...
			-- Nature's Grace
			{ spellID = 16886, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
	...
	["WARRIOR"] = {  -------------------------------------------------------------------------------------------------------- Warrior
		{
			...
			-- Victorious
			{ spellID = 32216, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
...
-- Firelands
		...
		-- Trinket Procs
			...
			{ spellID = 97138, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			...
			-- { spellID = 97142, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			-- Blessing of Khaz'goroth Heroic  / Apparatus of Khaz'goroth Heroic
			{ spellID = 97127, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			-- Soul Fragment Heroic  / Necromantic Focus Heroic
			{ spellID = 97131, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
			-- Devour Heroic  / The Hungerer Heroic
			{ spellID = 97125, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
		...
		-- Item Enchants - Engineering
			...
			{ spellID = 82175, size = 48, unitId = "player", caster = "player", filter = "BUFF" },
...
--[[       Tons of SpellIDs taken from LoseControl so credit to Kouri 
			...
			--Tiger's Fury
			{ spellID = 5217, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Barkskin
			{ spellID = 22812, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Berserk
			{ spellID = 50334, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Starfall
			{ spellID = 48505, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			
			--[[ Warrior ]]--
			--Spell Reflection
			{ spellID = 23920, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			--Recklessness
			{ spellID = 1719, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			--Shield Wall
			{ spellID = 871, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			--Shield Block
			{ spellID = 2565, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			--Retaliation
			{ spellID = 20230, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			--Enraged Regeneration
			{ spellID = 55694, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			--Rallying Cry
			{ spellID = 97462, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			--Deadly Calm
			{ spellID = 85730, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			--Death Wish
			{ spellID = 12292, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			...
			--Avenging Wrath
			{ spellID = 31884, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Divine Favor
			{ spellID = 31842, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Divine Guardian
			{ spellID = 70940, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Holy Shield
			{ spellID = 20925, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			...
			-- Water Shield
			{ spellID = 52127, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Earth Shield
			{ spellID = 974, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Elemental Mastery
			{ spellID = 16166, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Shamanistic Rage
			{ spellID = 30823, size = 60, unitId = "tagret", caster = "all", filter = "BUFF" },
			-- Feral Spirit
			{ spellID = 51533, size = 60, unitId = "target", caster = "all", filter = "BUFF" },

			--[[ Mage ]]--
			--Ice Block
			{ spellID = 45438, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Arcane Power
			{ spellID = 12042, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Icy Veins
			{ spellID = 12472, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			...
			-- Adrenaline Rush
			{ spellID = 13750, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Cold Blood
			{ spellID = 14177, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Shadow Dance
			{ spellID = 51713, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Vendetta
			{ spellID = 79140, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			
			--[[ Priest ]]--
			-- Dispersion
			{ spellID = 47585, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Archangel
			{ spellID = 87151, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Pain Suppression
			{ spellID = 33206, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
			-- Power Infusion
			{ spellID = 10060, size = 60, unitId = "target", caster = "all", filter = "BUFF" },
		},
		{
			...
			--Smoke Bomb
            { spellID = 76577, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },		
			--Garrote - Silence
			...
			--Holy Wrath
		    { spellID = 2812, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			--Turn Evil
            { spellID = 10326, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },	
			--Avenger's Shield
            ...
            { spellID = 18469, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			--Polymorph
			...
			--Fiery Payback
	        { spellID = 64346, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			...
			--Desecration
            { spellID = 55666, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },	
			--Chains of Ice
			...
			--Chilblains
	        { spellID = 50040, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },	
			--Dark Simulacrum
			...
			--Solar Beam
	        { spellID = 97547, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			--Entangling Roots
			...
			--Tendon Rip (Hyena)
	        { spellID = 50271, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			--Bad Manner (Monkey)
			...
			--[[ Shaman ]]--
			--Bind Elemental
	        { spellID = 76780, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			--Earthquake
	        { spellID = 61882, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			--Hex
			...
			--[[ Warlock ]]--
			--Aura of Foreboding
	        { spellID = 93986, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			--Axe Toss (Felguard)
			...
			--Demon Leap
	        { spellID = 54786, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			--Fear
			...
			--Heroic Leap
	        { spellID = 6544, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			--Intercept
	        { spellID = 20253, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },
			--Intimidating Shout
	        { spellID = 5246, size = 60, unitId = "player", caster = "all", filter = "DEBUFF" },	
			--Shockwave
